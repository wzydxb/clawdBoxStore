...
A Clawbox skill that removes signs of AI-generated writing from text, making it sound more natural and human.

## Installation

### Recommended (copy into Clawbox skills directory)

```bash
mkdir -p ~/.clawbox/skills/humanizer
cp SKILL.md ~/.clawbox/skills/humanizer/
```

### Manual install/update (only the skill file)

If you already have this skill locally (or you downloaded `SKILL.md`), copy the skill file into Clawbox's skills directory:
...
Or ask Clawbox to humanize text directly:
