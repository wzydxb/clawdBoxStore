...
## What this repo is
This repository is a **Clawbox skill** implemented entirely as Markdown.

The “runtime” artifact is `SKILL.md`: Clawbox reads the YAML frontmatter (metadata + allowed tools) and the prompt/instructions that follow.
...
## Common commands
### Install the skill into Clawbox
