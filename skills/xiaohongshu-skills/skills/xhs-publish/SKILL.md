...
# 步骤 2: 调用桌面截图技能只截取浏览器窗口（不要截整个桌面）发送给用户（截图完成前禁止继续）
...
# 步骤 5: 调用桌面截图技能只截取浏览器窗口（不要截整个桌面）发送给用户（截图完成后再汇报发布结果）
...
**Step B.3.5: 截图排版效果** — 调用桌面截图技能只截取浏览器窗口（不要截整个桌面）发送给用户展示排版效果。截图完成前不进入下一步。
...
**Step B.4.5: 截图模板效果** — 调用桌面截图技能只截取浏览器窗口（不要截整个桌面）发送给用户展示模板效果。截图完成前不进入下一步。
...
**Step B.6.5: 截图发布结果** — 调用桌面截图技能只截取浏览器窗口（不要截整个桌面）发送给用户确认已发布。截图完成后再汇报结果。
